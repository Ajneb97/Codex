...
public class CategoriesConfigManager extends DataFolderConfigManager {
    ...
    private boolean needFixingFiles;
    ...
    public void checkAndFix(){
        for(CommonConfig levelConfig : configFiles){
            FileConfiguration config = levelConfig.getConfig();
    ...
    public void loadConfigs() {
        ...
        if(needFixingFiles && OtherUtils.isLegacy()){
            checkAndFix();
            needFixingFiles = false;
        }

        for(CommonConfig levelConfig : configFiles){
            FileConfiguration config = levelConfig.getConfig();
            String name = levelConfig.getPath().replace(".yml","");
